...
const ACF_FIELDS = {
  ...
  course: [
    ...
    'emi_content', 'eligibility_content', 'admission_steps', 'admission_fee_note', 'syllabus_content',
  ...
  specialization: [
    'spec_name', 'university_name', 'linked_university', 'linked_course', 'hero_description',
    ...
    'certificate_heading', 'faqs_heading', 'about_content', 'eligibility_content', 'emi_content',
